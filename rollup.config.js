...
const modernConfig = {
  input: {
    ['auro-skeleton__bundled']: './src/auro-skeleton.js',
  },
  output: {
    format: 'esm',
    dir: 'dist/'
...
const auroSkeletonConfig = {
  input: 'src/es5.js',
  output: {
    format: 'iife',
    file: 'dist/auro-skeleton__bundled.es5.js'
  },
  plugins: getSharedPlugins(true)
};

export default [modernConfig, auroSkeletonConfig];
